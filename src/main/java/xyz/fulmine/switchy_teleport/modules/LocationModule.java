...
public class LocationModule implements SwitchyModule, SwitchyEvents.Init {
	final static Identifier ID = new Identifier(SwitchyTeleport.ID, "last_location");

	final static String KEY_LOCATION = "last_location";
	...
	public void applyToPlayer(ServerPlayerEntity player) {
		...
		if (this.location != null) {
			TeleportUtils.teleportPlayer(player, this.location);
		}
	}
